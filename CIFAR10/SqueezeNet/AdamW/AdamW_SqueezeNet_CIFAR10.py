...
def train(epoch, activation):
    ...
    correct    = 0
    total      = 0
    optimizer  = optim.AdamW(net.parameters(), lr=lr_schedule(lr, epoch), weight_decay=5e-3)#wd was 7e-2
...
torch.save(bestSishNet.state_dict(), "SqueezeNet_CIFAR10_AdamW_bestSishNet.pt")
torch.save(bestGELUNet.state_dict(), "SqueezeNet_CIFAR10_AdamW_bestGELUNet.pt")
torch.save(bestReLUNet.state_dict(), "SqueezeNet_CIFAR10_AdamW_bestReLUNet.pt")

with open('SqueezeNet_CIFAR10_Trial6.csv', 'w') as myfile:
