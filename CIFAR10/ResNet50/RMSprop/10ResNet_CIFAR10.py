...
def train(epoch, activation):
    ...
    correct    = 0
    total      = 0
    optimizer  = optim.RMSprop(net.parameters(), lr=lr_schedule(lr, epoch), weight_decay=0.001)
...
with open('ResNet_NO_CIFAR10_Trial10.csv', 'w') as myfile:
